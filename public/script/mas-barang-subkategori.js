$(function(){
    ...
    $('body').on('click', '#apply-filter', function(){
        ...
        var url = `sub-kategori/list?keyword=true&limit=${limit}${kode}${nama}`
        $.ajax({
            async: true,
            url: url,
            method: 'GET',
