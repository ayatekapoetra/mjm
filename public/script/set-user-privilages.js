$(function(){
    ...
    $('body').on('click', '#apply-filter', function(){
        ...
        var url = `users-privilages/list?keyword=true&limit=${limit}${nama_lengkap}${handphone}${alamat}${jenkel}`
        $.ajax({
            async: true,
            url: url,
            method: 'GET',
        ...
        swal({
          ...
          function(){
              $.ajax({
                  async: true,
                  headers: {'x-csrf-token': $('[name=_csrf]').val()},
                  url: 'users-privilages/'+id+'/destroy',
                  method: 'DELETE',
                  dataType: 'json',
                  processData: false,
                  mimeType: "multipart/form-data",
    ...
    $('body').on('submit', 'form#form-update', function(e){
        ...
        $.ajax({
            async: true,
            headers: {'x-csrf-token': $('[name=_csrf]').val()},
            url: 'users-privilages/'+id+'/update',
            method: 'POST',
            data: data,
            dataType: 'json',
            processData: false,
