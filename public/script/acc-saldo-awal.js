$(function(){
    ...
    $('body').on('click', '#apply-filter', function(){
        ...
        var url = `saldo-awal/list?keyword=true&limit=${limit}${kode}${serial}${num_part}${nama}${satuan}`
        $.ajax({
            async: true,
            url: url,
            method: 'GET',
