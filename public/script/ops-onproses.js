$(function(){
    ...
    $('body').on('click', '#apply-filter', function(){
        ...
        var url = `onproses/list?keyword=true&limit=${limit || 100}${start_service_begin}${start_service_end}${priority}${status}${equipment_id}`
