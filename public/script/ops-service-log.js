$(function(){
    ...
    $('body').on('click', '#apply-filter', function(){
        ...
        var start_service_begin = $('input[name="start_service_begin"]').val() && '&start_service_begin=' + $('input[name="start_service_begin"]').val()
        var start_service_end = $('input[name="start_service_end"]').val() && '&start_service_end=' + $('input[name="start_service_end"]').val()
        ...
        var url = `services-log/list?keyword=true&limit=${limit || 100}${start_service_begin}${start_service_end}${priority}${status}${equipment_id}`
    ...
    function addItems(len){
        for (let index = 0; index < len; index++) {
            $.ajax({
                async: true,
                url: 'services-log/create/add-item',
                method: 'GET',
                dataType: 'html',
                contentType: false,
                success: function(result){
