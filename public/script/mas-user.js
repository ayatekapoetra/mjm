$(function(){
    ...
    $('body').on('click', '#apply-filter', function(){
        ...
        var nama_lengkap = $('input[name="nama_lengkap"]').val() && '&nama_lengkap=' + $('input[name="nama_lengkap"]').val()
        var handphone = $('input[name="handphone"]').val() && '&handphone=' + $('input[name="handphone"]').val()
        var alamat = $('input[name="alamat"]').val() && '&alamat=' + $('input[name="alamat').val()
        var jenkel = $('select[name="jenkel"]').val()  && '&jenkel=' + $('select[name="jenkel"]').val()
        var url = `users/list?keyword=true&limit=${limit}${nama_lengkap}${handphone}${alamat}${jenkel}`
        $.ajax({
            async: true,
            url: url,
            method: 'GET',
